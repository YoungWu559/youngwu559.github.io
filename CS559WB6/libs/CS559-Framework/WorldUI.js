...
export class WorldUI {
    ...
    constructor(world, width = -1, where = undefined, grading = false) {
        ...
        if (width > 0) {
            ...
            gui.add(obj, "speed", 0.1, 3, 0.1).onChange(function (value) {
            ...
            let gui_camera = gui.add(obj, "camera", ["Orbit Camera", "Fly Camera", "Follow Object", "Drive Object"]).onChange(function (value) {
